...
<div class="row">
    <div class="col-md-3">
        <img src="{{ url($manager->avatar) }}" class="img-circle" width="300" height="300">
    </div>
    <div class="col-md-6 ">
        ...
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" class="form-horizontal" action="/managers/{{ $manager->id }}"  enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="box-body">
                    <label>Email</label>        
